...
export default function ShiftDetailPage() {
    ...
    if (isLoading) return <PageLayout><div className={styles.loading}>Loading...</div></PageLayout>;
    if (!shift) return <PageLayout><div className={styles.error}>Shift not found.</div></PageLayout>;
