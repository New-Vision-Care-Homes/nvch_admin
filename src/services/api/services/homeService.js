...
export const homeService = {
	 ...
	 */
	getAll: async (params = {}) => {
		const { data } = await axiosClient.get(API_ENDPOINTS.HOMES.BASE, { params });
	 ...
	 */
	getHome: async (id) => {
		const { data } = await axiosClient.get(API_ENDPOINTS.HOMES.BY_ID(id));
		return data.data;
	},
	...
	create: async (homeData) => {
		const { data } = await axiosClient.post(API_ENDPOINTS.HOMES.BASE, homeData);
		return data.data;
	},
	...
	update: async (id, updateData) => {
		const { data } = await axiosClient.put(API_ENDPOINTS.HOMES.BY_ID(id), updateData);
		return data.data;
	},
	 ...
	 */
	delete: async (id) => {
		const { data } = await axiosClient.delete(API_ENDPOINTS.HOMES.BY_ID(id));
		return data.data;
	}
};
